...
<div class="home">
 ...
 <form action="mfc.lib" method="post">

        <table><tr>
        <th colspan="3"><h2>Libération Exeptionnlle</h2></th>
        </tr><tr>
        <td><h4>Nombre de semaines : </h4></td></tr>
       <tr> <td><input type="number" id="nbr" name="nbr" placeholder="0">
	</td></tr>
	<tr><td colspan="2">
	<input type="hidden" name="id" value="<%= id %>">
	<input type="submit" name="action" class="bttn" value="Valider la liberation">
	</td></tr>
        </table>
